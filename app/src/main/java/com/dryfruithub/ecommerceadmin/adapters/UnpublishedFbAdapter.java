...
public class UnpublishedFbAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    Context context;
    public static ArrayList<ProductsOnFirebase> unPublishedList = new ArrayList<>();

    public UnpublishedFbAdapter(Context applicationContext, ArrayList<ProductsOnFirebase> unPublishedList) {
        this.context = applicationContext;
        this.unPublishedList = unPublishedList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UnpublishedFbAdapter.ProductViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        ProductsOnFirebase unpublishedProduct = unPublishedList.get(position);

        final int discount,max_price;
        final String p_id;
        float discounted_price;
        discount = unpublishedProduct.getP_discount();
        max_price = unpublishedProduct.getP_price();
        ...
        productViewHolder.prod_name.setText(unpublishedProduct.getP_full_name());
